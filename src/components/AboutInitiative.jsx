      ...
      <section className="py-[120px] px-[215px]">
        <div className="max-w-[1170px] mx-auto flex flex-col gap-[50px]">
          ...
          <div className="flex flex-col gap-6">
            ...
            <ul className="list-disc list-inside space-y-2 text-[#333] text-base leading-[160%]">
          ...
          <div className="flex flex-col gap-8 bg-gray-50 p-8 rounded-2xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              ...
              <div className="flex flex-col items-center gap-10">
                <div className="w-[100px] h-[100px] rounded-full border border-[#d9d9d9] flex items-center justify-center bg-white">
                  <PieChart
