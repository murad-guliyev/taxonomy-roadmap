      ...
      <section className="py-[60px] sm:py-[90px] lg:py-[120px] px-4 sm:px-6">
        <div className="max-w-[1170px] mx-auto flex flex-col gap-8 sm:gap-10 lg:gap-[50px]">
          ...
          <div className="flex flex-col gap-6 sm:gap-8">
            <p className="text-muted-foreground text-[14px] sm:text-base leading-[160%]">
          ...
          <div className="flex flex-col gap-4 sm:gap-6">
            <h2 className="text-foreground text-lg sm:text-xl font-semibold leading-[130%]">
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground text-[14px] sm:text-base leading-[160%] pl-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 gap-8 lg:gap-10">
              ...
              <div className="flex flex-col  gap-6 lg:gap-10">
                ...
                <div className="flex flex-col gap-3 sm:gap-5 ">
                  <h3 className="text-foreground text-base sm:text-lg font-semibold leading-[130%]">
          ...
          <div className="flex flex-col gap-4 sm:gap-6">
            ...
            <p className="text-muted-foreground text-[14px] sm:text-base font-semibold leading-[170%]">
